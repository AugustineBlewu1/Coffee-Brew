          ...
          if (snapshot.hasData) {
            ...
            return Form(
              ...
              child: Column(children: [
                ...
                //slider
                Slider(
                  value: (_currentStrength ?? userData.strenth).toDouble(),
                  activeColor:
                      Colors.brown[_currentStrength ?? userData.strenth],
                  inactiveColor:
                      Colors.brown[_currentStrength ?? userData.strenth],
                  min: 100.0,
                  max: 900.0,
                    ...
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        await DatabaseService(uid: user.uid).updateUserData(
                            ...
                            _currentStrength ?? userData.strenth);
